...
You need **either** this key **or** a [Gemini key](gemini.md) to run AutoFLUKA at all; one of the two is required as AutoFLUKA's chat model.
...
- If you'd rather avoid billing setup entirely, [Gemini](gemini.md) covers the same required role (AutoFLUKA's chat model) for free.
