...
Tavily powers AutoFLUKA's live web search. It's optional: AutoFLUKA runs fine without it, and skipping it only means the agent can't look up current information from the web.
...
- If you ever exhaust your free credits or Tavily has an outage, AutoFLUKA does not simply fail, see the [Google Custom Search guide](google-custom-search.md) for the optional automatic backup path.
