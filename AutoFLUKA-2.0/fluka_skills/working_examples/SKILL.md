---
name: FLUKA Working Examples
description: Bundled validated FLUKA example decks and README-style notes beside canonical .inp files.
---
...
## Examples
- `spallation/` - Generic spallation source station with concentric annular layers and multi-family scoring (USRBDX/USRTRACK/USRBIN/RESNUCLEi). Uses the FLUKA/FLAIR axis convention (x up, z along beam).
