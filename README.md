...
2) Download the zip archive that contains the image tarball [here](https://tamucs-my.sharepoint.com/:u:/g/personal/zavier_ndum_tamu_edu/IQDKq3ytFZ-YS4byCVxAJLCaAQ0ulL0k8smhp-y2pO0fx2E?email=zavier.ndum%40tamu.edu&e=uecUKd). You will be prompted to enter your email address to request access. **Please note**: Access is not instant. Your request will be reviewed within 24 hours, and you will receive a separate email once approved. Thank you for your patience!"
