...
- **Symptom:** A tool call fails with `Invalid argument provided to Gemini: 400 Function call is missing a thought_signature in functionCall parts...`. This can happen even after an earlier tool call in the same session succeeded.
